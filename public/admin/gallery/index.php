  ...
  <body class="dash-body">
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <a href="./index.php" class="menu-item active">Galerie</a>
      </nav>
    ...
    <main class="content">
      ...
      <section class="panel">
        <div class="panel-header">Ajouter une image</div>
      ...
      <section class="panel" style="margin-top:16px;">
        <div class="panel-header">Liste des images</div>
        <div class="panel-body">
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form action="remove.php" method="post" onsubmit="return confirm('Supprimer cette image ?');" style="display:inline">
