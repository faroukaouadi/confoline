    ...
    <main class="content">
      <header class="topbar">
        ...
        <div class="header-actions">
          <button onclick="showAddPartnerForm()" class="btn btn-success">Add New Partner</button>
        </div>
      </header>
      ...
      <div id="addPartnerForm" class="search-filters" style="display: none;">
        <h3 style="color: var(--text); margin-bottom: 20px;">Add New Partner</h3>
      ...
      <!-- Partners List -->
      <div class="results-count">Found <?php echo count($partners); ?> partner(s)</div>
