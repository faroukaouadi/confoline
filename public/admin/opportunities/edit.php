    ...
    try {
        ...
        $stmt = $pdo->prepare("
            UPDATE opportunities SET 
                title = ?, department = ?, location = ?, work_type = ?, status = ?, 
        ...
        $stmt->execute([
            ...
            $experience_level, $application_deadline, $id
        ]);
                ...
                <form method="POST" action="">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="department" name="department" required 
                                   value="<?php echo htmlspecialchars($opportunity['department']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="work_type" name="work_type">
                                <option value="Full-time" <?php echo $opportunity['work_type'] === 'Full-time' ? 'selected' : ''; ?>>Full-time</option>
                                <option value="Part-time" <?php echo $opportunity['work_type'] === 'Part-time' ? 'selected' : ''; ?>>Part-time</option>
                                <option value="Contract" <?php echo $opportunity['work_type'] === 'Contract' ? 'selected' : ''; ?>>Contract</option>
                                <option value="Remote" <?php echo $opportunity['work_type'] === 'Remote' ? 'selected' : ''; ?>>Remote</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="status" name="status">
                                ...
                                <option value="On-hold" <?php echo $opportunity['status'] === 'On-hold' ? 'selected' : ''; ?>>On-hold</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="experience_level">Experience Level</label>
                            <select id="experience_level" name="experience_level">
                                <option value="Entry-level" <?php echo $opportunity['experience_level'] === 'Entry-level' ? 'selected' : ''; ?>>Entry-level</option>
                                <option value="Mid-level" <?php echo $opportunity['experience_level'] === 'Mid-level' ? 'selected' : ''; ?>>Mid-level</option>
                                <option value="Senior" <?php echo $opportunity['experience_level'] === 'Senior' ? 'selected' : ''; ?>>Senior</option>
                                <option value="Executive" <?php echo $opportunity['experience_level'] === 'Executive' ? 'selected' : ''; ?>>Executive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="salary_range" name="salary_range" 
                                   ...
                                   value="<?php echo htmlspecialchars($opportunity['salary_range']); ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="large" required 
                                  placeholder="Describe the role, what the candidate will do, and what makes this opportunity exciting..."><?php echo htmlspecialchars($opportunity['description']); ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="requirements">Requirements</label>
                        <textarea id="requirements" name="requirements" 
                                  placeholder="List the required skills, experience, and qualifications..."><?php echo htmlspecialchars($opportunity['requirements']); ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="responsibilities">Key Responsibilities</label>
                        <textarea id="responsibilities" name="responsibilities" 
                                  placeholder="List the main responsibilities and duties..."><?php echo htmlspecialchars($opportunity['responsibilities']); ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="benefits">Benefits & Perks</label>
                        <textarea id="benefits" name="benefits" 
                                  placeholder="List the benefits, perks, and what you offer..."><?php echo htmlspecialchars($opportunity['benefits']); ?></textarea>
                    </div>
