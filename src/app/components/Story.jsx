    ...
    <section className="relative bg-[url('/images/bg-story.png')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="relative z-10 max-w-5xl 2xl:max-w-[80%] mx-auto px-4 py-22 2xl:py-32 text-center">
        ...
        <div className="mt-6 flex items-center justify-center gap-3 sm:gap-4">
          <button className="px-4 py-2 sm:px-5 sm:py-2.5 2xl:px-6 2xl:py-3 cursor-pointer rounded-full border border-gray-900 text-gray-900 font-medium hover:bg-gray-50 text-sm sm:text-base">
            View all stories
          </button>
          <button className="inline-flex items-center gap-1.5 sm:gap-2 cursor-pointer text-gray-900 hover:text-white font-medium text-xs sm:text-sm 2xl:text-base">
            See what we deliver
