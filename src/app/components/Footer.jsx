        ...
        <div className="grid gap-6 lg:gap-6 lg:grid-cols-6">
          ...
          <div className="lg:col-span-4">
            ...
            <div>
              ...
              <ul className="space-y-3 text-[13px] 2xl:text-[18px]">
                <li><Link href="http://vision.confoline.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">Overview</Link></li>
                <li><Link href="http://vision.confoline.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">Explore Vision Experience</Link></li>
            ...
            {/* Social icons */}
              <div className="col-span-2 flex items-center gap-3 mt-2">
               <Link aria-label="LinkedIn" href="https://www.linkedin.com/company/confoline/" target="_blank" rel="noopener noreferrer" className="p-1 rounded-full text-[#51A2FF] hover:bg-white/10">
               ...
               <Link aria-label="YouTube" href="https://www.youtube.com/channel/UCQw33UbrvXwiy660xzIrY5w" target="_blank" rel="noopener noreferrer" className="p-1  rounded-full text-[#51A2FF] hover:bg-white/10">
          ...
          <div className="lg:col-span-2 flex justify-center md:justify-end">
            <div className="bg-[#0A2A57] text-white rounded-xl p-2 sm:p-3 shadow-xl ring-1 ring-black/10 max-w-xs 2xl:max-w-lg w-full">
              <div className="relative w-full h-32 sm:h-47 2xl:h-[75%]  rounded-lg overflow-hidden">
                <iframe
              ...
              <div className="flex items-start gap-2 text-[12px] sm:text-sm mt-4 2xl:mt-6">
                <MapPin />
                <div>
                  <p className="font-medium text-xs sm:text-sm 2xl:text-lg">Confoline — 6 RUE DES BATELIERS</p>
                  <p className="text-white/80 text-xs sm:text-sm 2xl:text-base">92110 CLICHY, France</p>
                </div>
              </div>
            </div>
          </div>
