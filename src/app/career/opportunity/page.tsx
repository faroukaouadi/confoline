...
function OpportunityContent() {
  ...
  const shareOnLinkedIn = () => {
    ...
    const summary = encodeURIComponent(
      `🚀 Exciting job opportunity at Confoline!\n\n` +
      `Position: ${opportunity.title}\n` +
      `Department: ${opportunity.department}\n` +
      `Location: ${opportunity.location}\n` +
      `Work Type: ${opportunity.work_type}\n\n` +
      `Join our innovative team and help build the future of intelligent automation! 💼\n\n` +
      `#Jobs #Career #Confoline #AI #Automation #TechJobs`
    );
                ...
                <div className="bg-[#1A337D] p-6 rounded-2xl">
                  ...
                  <div className="grid grid-cols-2 place-items-center gap-3">
                    <button 
                      ...
                      className="w-full h-auto p-3 bg-[#162456] rounded-2xl flex flex-col items-center justify-center hover:bg-gray-700 transition-colors group"
                    ...
                    <button 
                      onClick={copyLink}
                      className={`w-full h-auto p-3 rounded-2xl flex flex-col items-center justify-center transition-colors group relative ${
                        copySuccess 
                          ? 'bg-green-600 hover:bg-green-700' 
                          : 'bg-[#162456] hover:bg-gray-700'
                      }`}
                    ...
                    >
                      {copySuccess ? (
                        ...
                        <>
                          <svg className="w-5 h-5 group-hover:scale-110 transition-transform mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
